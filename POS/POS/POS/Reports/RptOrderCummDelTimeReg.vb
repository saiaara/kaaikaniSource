...
Public Class RptOrderCummDelTimeReg
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptOrderCummDelTimeReg.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS.RptOrderCummDelTimeReg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptOrderCummDelTimeReg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptOrderCummDelTimeReg = New RptOrderCummDelTimeReg()
        rpt.Site = Me.Site
        Return rpt
    End Function
