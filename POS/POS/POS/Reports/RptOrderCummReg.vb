...
Public Class RptOrderCummReg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS.RptOrderCummReg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptOrderCummReg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptOrderCummReg = New RptOrderCummReg()
        rpt.Site = Me.Site
        Return rpt
    End Function
