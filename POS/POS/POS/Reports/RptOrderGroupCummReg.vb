...
Public Class RptOrderGroupCummReg
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptOrderGroupCummReg.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS.RptOrderGroupCummReg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptOrderGroupCummReg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptOrderGroupCummReg = New RptOrderGroupCummReg()
        rpt.Site = Me.Site
        Return rpt
    End Function
