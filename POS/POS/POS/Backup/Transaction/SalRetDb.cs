...
# region "Selection Source"
        ...
        public DataTable ItemSelect_Source(bool Product, int SalId, int AcYrId)
        {
            SqlConnection MyCon = new SqlConnection();
            SqlCommand MyCmd = new SqlCommand();
            SqlParameter MyParam = new SqlParameter();
        ...
        public int ItemSelect_GridStyle(DataGridViewColumnCollection tmp)
        {
            ...
            tmp.Add(CommonView.GetGridViewColumn("PackType", "PackType", 80, 8, true, DataGridViewContentAlignment.MiddleLeft, ""));
            tmp.Add(CommonView.GetGridViewColumn("UnitId", "UnitId", 0, 9));
            tmp.Add(CommonView.GetGridViewColumn("Unit", "Unit", 70, 10, true, DataGridViewContentAlignment.MiddleLeft));
            tmp.Add(CommonView.GetGridViewColumn("Qty", "Qty", 60, 11, false, DataGridViewContentAlignment.MiddleRight, "#####0"));
            ...
            tmp.Add(CommonView.GetGridViewColumn("TaxName", "TaxName", 80, 14, true, DataGridViewContentAlignment.MiddleLeft));
            tmp.Add(CommonView.GetGridViewColumn("TaxPer", "TaxPer", 0, 15));//, true, DataGridViewContentAlignment.MiddleRight, "#####0.00"));            
            tmp.Add(CommonView.GetGridViewColumn("ItemDiscPer", "ItemDiscPer", 60, 16, false, DataGridViewContentAlignment.MiddleRight, "#####0.00"));
            tmp.Add(CommonView.GetGridViewColumn("ItemDiscValue", "ItemDiscValue", 60, 17, false, DataGridViewContentAlignment.MiddleRight, "#####0.00"));
            tmp.Add(CommonView.GetGridViewColumn("ConvFact", "ConvFact", 0, 18));            
            tmp.Add(CommonView.GetGridViewColumn("SUOMId", "SuomId", 0, 19));
            ...
            //////tmp.Add(CommonView.GetGridViewBoolColumn("Selection", "Selection", 50, 2));
            //////tmp.Add(CommonView.GetGridViewColumn("Itemcode", "Code", 0, 3, false, DataGridViewContentAlignment.MiddleLeft));
            //////tmp.Add(CommonView.GetGridViewColumn("ItemName", "ItemName", 120, 4, false, DataGridViewContentAlignment.MiddleLeft, "",DataGridViewAutoSizeColumnMode.Fill));//, DataGridViewAutoSizeColumnMode.Fill));
            //////tmp.Add(CommonView.GetGridViewColumn("CategoryId", "CategoryId", 0, 5));
            //////tmp.Add(CommonView.GetGridViewColumn("Category", "Category",80, 6));//,true,DataGridViewContentAlignment.MiddleLeft));
            //////tmp.Add(CommonView.GetGridViewColumn("PackTypeId", "PackTypeId", 0, 7));
            //////tmp.Add(CommonView.GetGridViewColumn("PackType", "PackType", 80, 8,true, DataGridViewContentAlignment.MiddleLeft, ""));
        ...
        public DataTable Unit_Source(int ItemId)
        {
            ...
            MyCmd = new SqlCommand("Qry_SalUnitSelect", MyCon);
            MyCmd.CommandType = CommandType.StoredProcedure;
        ...
        public int Unit_GridStyle(DataGridViewColumnCollection tmp)
        {
            ...
            tmp.Add(CommonView.GetGridViewColumn("DealerRate", "DealerRate", 80, 3, true, DataGridViewContentAlignment.MiddleLeft, "####0.00"));
            tmp.Add(CommonView.GetGridViewColumn("SalRate", "SalRate", 80, 4, true, DataGridViewContentAlignment.MiddleLeft, "####0.00"));
            tmp.Add(CommonView.GetGridViewColumn("ConvFact", "ConvFact", 0, 5));
        ...
        public DataTable TaxSelect_Source(short Taxid, bool Vat)
        {
            SqlConnection MyCon = new SqlConnection();
            SqlCommand MyCmd = new SqlCommand();
            SqlParameter MyParam = new SqlParameter();
            ...
            MyCmd = new SqlCommand("Qry_SalRetTaxSelect", MyCon);
            MyCmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable BillNo_Source(int PtyId, DateTime Dt, short AcYrId, bool Retail, short CAcYrId, int Offer)
        {
            SqlConnection MyCon = new SqlConnection();
            SqlCommand MyCmd = new SqlCommand();
            SqlParameter MyParam = new SqlParameter();
            ...
            MyParam = new SqlParameter("@Offer", SqlDbType.Int);
            MyParam.Value = Offer;
            MyCmd.Parameters.Add(MyParam);
        ...
        public int BillNo_GridStyle(DataGridViewColumnCollection tmp)
        {
            ...
            tmp.Add(CommonView.GetGridViewColumn("Retail", "Retail", 0, 7));
...
# region "Save Function"
        ...
        public string SaveFunction(Saving.SaveType Mode)
        {
            ...
            try
            {
                ...
                param = new SqlParameter("@ToProduct", SqlDbType.Bit);
                param.Value = (_ToProduct == true ? 1 : 0);
                Cmd.Parameters.Add(param);
                ...
                param = new SqlParameter("@Retail", SqlDbType.Char,1);
                param.Value = _Retail;
                Cmd.Parameters.Add(param);
                ...
                param = new SqlParameter("@SalRetInvNo", SqlDbType.VarChar, 20);
                param.Value = _SalRetInvNo;
                Cmd.Parameters.Add(param);
                ...
                param = new SqlParameter("@Narration", SqlDbType.VarChar, 50);
...
# region "Details"
        public DataTable SalRetTaxDet_Source(int SalRetId)
        {
            DataTable Tbl = new DataTable();
            SqlConnection Con = new SqlConnection(Common.ConStr);
            SqlDataAdapter Da = new SqlDataAdapter();
        ...
        public int SalRetTaxDet_GridStyle(DataGridViewColumnCollection tmp)
        {
            tmp.Clear();
        ...
        public int SalRetDet_GridStyle(DataGridViewColumnCollection tmp)
        {
            ...
            tmp.Add(CommonView.GetGridViewColumn("Itemcode", "ItemCode", 100, 3, false, DataGridViewContentAlignment.MiddleLeft,""));
            tmp.Add(CommonView.GetGridViewColumn("ItemName", "ItemName", 120, 4, false, DataGridViewContentAlignment.MiddleLeft, ""));  //, DataGridViewAutoSizeColumnMode.Fill            
            tmp.Add(CommonView.GetGridViewColumn("CategoryId", "CategoryId", 0, 5));
            tmp.Add(CommonView.GetGridViewColumn("Category", "Category", 60,6, true, DataGridViewContentAlignment.MiddleLeft));//,true,DataGridViewContentAlignment.MiddleLeft));
            tmp.Add(CommonView.GetGridViewColumn("PackType", "PackType", 60, 7, true, DataGridViewContentAlignment.MiddleLeft));
            tmp.Add(CommonView.GetGridViewColumn("PackTypeId", "PackTypeId", 0, 8));
            tmp.Add(CommonView.GetGridViewColumn("UnitId", "UnitId", 0, 9));
            tmp.Add(CommonView.GetGridViewColumn("Unit", "Unit", 50, 10, true, DataGridViewContentAlignment.MiddleLeft));
            tmp.Add(CommonView.GetGridViewColumn("Qty", "Qty", 50, 11, false, DataGridViewContentAlignment.MiddleRight, "#####0"));
            tmp.Add(CommonView.GetGridViewColumn("Rate", "Rate", 60, 12, false, DataGridViewContentAlignment.MiddleRight, "#####0.00"));
            tmp.Add(CommonView.GetGridViewColumn("InclAmt", "InclAmt", 60, 13, true, DataGridViewContentAlignment.MiddleRight, ""));
            tmp.Add(CommonView.GetGridViewColumn("ItemDiscPer", "Disc%", 50, 14, false, DataGridViewContentAlignment.MiddleRight, "#####0.00"));
            tmp.Add(CommonView.GetGridViewColumn("ItemDiscValue", "DiscAmt", 60, 15, true, DataGridViewContentAlignment.MiddleRight, "#####0.00"));
            tmp.Add(CommonView.GetGridViewColumn("Amount", "Amount", 70, 16, true, DataGridViewContentAlignment.MiddleRight, "#####0.00"));
            tmp.Add(CommonView.GetGridViewColumn("TaxId", "TaxId", 0, 17));
            tmp.Add(CommonView.GetGridViewColumn("TaxName", "TaxName", 60, 18, true, DataGridViewContentAlignment.MiddleLeft));
            tmp.Add(CommonView.GetGridViewColumn("TaxPer", "TaxPer", 0, 19));//, true, DataGridViewContentAlignment.MiddleRight, "#####0.00"));
            tmp.Add(CommonView.GetGridViewColumn("TaxAmt", "TaxAmt", 60, 20, true, DataGridViewContentAlignment.MiddleRight, "####0.00"));
            tmp.Add(CommonView.GetGridViewColumn("SQty", "SQty", 0, 21));
            tmp.Add(CommonView.GetGridViewColumn("ConvFact", "ConvFact", 0, 22));            
            tmp.Add(CommonView.GetGridViewColumn("SUOMId", "SuomId", 0, 23));
            tmp.Add(CommonView.GetGridViewColumn("SlNo", "SlNo", 0, 24));
        ...
        public int OfferItemSelect_GridStyle(DataGridViewColumnCollection tmp)
        {
            ...
            tmp.Add(CommonView.GetGridViewColumn("ConvFact", "ConvFact", 0, 18));
            //tmp.Add(CommonView.GetGridViewColumn("SQty", "SQty", 0, 24));
            tmp.Add(CommonView.GetGridViewColumn("SUOMId", "SuomId", 0, 19));
...
# region "Fetch Record"
        ...
        public bool FetchRecord(int Id)
        {
            ...
            if (rd.Read())
            {
                ...
                _ToProduct = (bool)rd.GetValue(rd.GetOrdinal("ToProduct"));
                _SalId = (int)rd.GetValue(rd.GetOrdinal("SalId"));
                _SalBillNo = (int)rd.GetValue(rd.GetOrdinal("SalBillNo"));
                _Retail = (string)rd.GetValue(rd.GetOrdinal("Retail"));
                _Total = (decimal)rd.GetValue(rd.GetOrdinal("Total"));
        ...
        #region "Sales Return Print"
        public DataTable SalRetPrint(int SalId)
        {
            SqlConnection MyCon = new SqlConnection();
            SqlCommand MyCmd = new SqlCommand();
            SqlParameter MyParam = new SqlParameter();
...
#region "For View Record"
        ...
        public DataTable navigate()
        {
            ...
            Con.Open();
            SqlCommand Cmd;
            Cmd = new SqlCommand("select top 100 * from SalRetHdrVwFn(" + Common.CId + ") where SalRetNo > 0 order by SalRetNo desc", Con);
        ...
        public int View_GridStyle(DataGridViewColumnCollection tmp)
        {
            ...
            //tmp.Add(CommonView.GetGridViewColumn("Remarks", "Remarks", 100, 7, true, DataGridViewContentAlignment.MiddleLeft, ""));
