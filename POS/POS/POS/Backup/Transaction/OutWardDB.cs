    ...
    public class OutWardDB
    {
        ...
        public void  SaveFunction(Saving.SaveType Mode)
        {
            ...
            try
            {
                ...
                Con.Open();
                SqlCommand Cmd;
                Cmd = new SqlCommand("OutwardSP", Con);
                Cmd.CommandType = CommandType.StoredProcedure;
                SqlParameter param = new SqlParameter("@Mode", SqlDbType.TinyInt);
                param.Value = Modeval;
                Cmd.Parameters.Add(param);

                param = new SqlParameter("@OutWardId", SqlDbType.Int);
                param.Value = _OutWardId  ;
                Cmd.Parameters.Add(param);

                param = new SqlParameter("@OutWardNo", SqlDbType.Int);
                param.Value = _OutWardNo ;
                Cmd.Parameters.Add(param);


                param = new SqlParameter("@OutWardDt", SqlDbType.DateTime);
                param.Value = _OutWardDt  .ToString("dd/MM/yyyy");
                Cmd.Parameters.Add(param);
                ...
                param = new SqlParameter("@Totwt", SqlDbType.Decimal);
                param.Value = _Totwt ;
                Cmd.Parameters.Add(param);

                param = new SqlParameter("@TotwstWt", SqlDbType.Decimal);
                param.Value = _TotwstWt ;
                Cmd.Parameters.Add(param);
       ...
       public DataTable Cuscode_cheking(int configid)
        ...
        public DataTable InwSelection_Source()
        {
            SqlConnection MyCon = new SqlConnection();
            SqlCommand MyCmd = new SqlCommand();
            SqlParameter MyParam = new SqlParameter();
            ...
            MyCmd = new SqlCommand("Qry_InwardSelection", MyCon);
            MyCmd.CommandType = CommandType.StoredProcedure;
            ...
            DTbl.TableName = "InwardSelection";
            MyAdapt.Dispose();
            MyCmd.Dispose();
            MyCon.Close();
            return DTbl;
        ...
        public int InwSelection_GridStyle(DataGridViewColumnCollection tmp)
        {
            tmp.Clear();
            tmp.Add(CommonView.GetGridViewColumn("InwId", "InwId", 0, 1));
            tmp.Add(CommonView.GetGridViewColumn("Inwno", "Inwno", 150, 2, true));
            tmp.Add(CommonView.GetGridViewColumn("InwDt", "InwDt", 120, 3));
            tmp.Add(CommonView.GetGridViewColumn("PtyId", "PtyId", 0, 4, true));
            tmp.Add(CommonView.GetGridViewColumn("Customer", "Customer", 0, 5, true));
            tmp.Add(CommonView.GetGridViewColumn("Add1", "Add1", 0, 6, true));
            tmp.Add(CommonView.GetGridViewColumn("TotQty", "TotQty", 80, 7, true));
            tmp.Add(CommonView.GetGridViewColumn("TotAmt", "TotAmt", 0, 8, true));
            tmp.Add(CommonView.GetGridViewColumn("Remarks", "Remarks", 80, 9, true));
        ...
        public int ItemSelect_GridStyle(DataGridViewColumnCollection tmp)
        {
            ...
            tmp.Add(CommonView.GetGridViewColumn("Category", "Category", 0, 4, false));
        ...
        public bool FetchRecord(int Id)
        {
            ...
            Con.Open();
            SqlCommand Cmd;
            Cmd = new SqlCommand("Qry_OutwardHDr", Con);
            Cmd.CommandType = CommandType.StoredProcedure;
            SqlParameter param = new SqlParameter("OutwardId", SqlDbType.Int);
            param.Value = Id;
            Cmd.Parameters.Add(param);
            ...
            if (rd.Read())
            {
                _OutWardId  = (int)rd.GetValue(rd.GetOrdinal("OutwardId"));
                _OutWardNo  = (int)rd.GetValue(rd.GetOrdinal("OutwardNo"));
                _OutWardDt  = (DateTime)rd.GetValue(rd.GetOrdinal("OutwardDt"));       
               
                _TotQty = (decimal)rd.GetValue(rd.GetOrdinal("TotQty"));
                _TotAmt  = (decimal)rd.GetValue(rd.GetOrdinal("TotAmt"));
                 _Totwt = (decimal)rd.GetValue(rd.GetOrdinal("Totwt"));
                _TotwstWt  = (decimal)rd.GetValue(rd.GetOrdinal("TotWstWt"));
        ...
        public DataTable navigate()
        {
            ...
            Con.Open();
            SqlCommand Cmd;
            Cmd = new SqlCommand("Select Top 100 * From OutWardHdrVwFn(" + Common.CId + ") where OutwardId > 0 order by OutwardId desc", Con);
            Cmd.CommandType = CommandType.Text;

            Da.SelectCommand = Cmd;
            Da.Fill(Tbl);
            Tbl.TableName = "OutWardHdrVwFn";
            Da.Dispose();
            Cmd.Dispose();
            Con.Close();
            return Tbl;
        ...
        public void SetViewControl()
        {
            ...
            _View.TableNames = "OutWardHdrVwFn(" + Common.CId + ")";
            _View.Fields = "*";
            _View.Conditions = "";
            _View.OrderBy = "OutwardId";
        }
        ...
        {
            tmp.Clear();
            tmp.Add(CommonView.GetGridViewColumn("OutwardId", "OutwardId", 0, 1));
            tmp.Add(CommonView.GetGridViewColumn("OutwardNo", "OutwardNo", 90, 2));
            tmp.Add(CommonView.GetGridViewColumn("OutwardDt", "OutwardDt", 90, 3, true, DataGridViewContentAlignment.MiddleLeft, "dd/MM/yyyy"));        
            tmp.Add(CommonView.GetGridViewColumn("TotQty", "TotQty", 100, 6, true, DataGridViewContentAlignment.MiddleLeft, "#####0.00"));
            tmp.Add(CommonView.GetGridViewColumn("Totwt", "Totwt", 100, 7, true, DataGridViewContentAlignment.MiddleLeft, "#####0.00"));
            tmp.Add(CommonView.GetGridViewColumn("TotAmt", "TotAmt", 0, 8, true, DataGridViewContentAlignment.MiddleLeft, "#####0.000"));
            tmp.Add(CommonView.GetGridViewColumn("Remarks", "Remarks", 80, 9, true, DataGridViewContentAlignment.MiddleLeft, "", DataGridViewAutoSizeColumnMode.Fill));            
            tmp.GetFirstColumn(DataGridViewElementStates.None).Visible = false;
        ...
        public DataTable OutWardDet_Source(int Id)
        {
            DataTable Tbl = new DataTable();
            SqlConnection Con = new SqlConnection(Common.ConStr);
            SqlDataAdapter Da = new SqlDataAdapter();
            Con.Open();
            SqlCommand Cmd;
            Cmd = new SqlCommand("Qry_OutwardDet", Con);
            Cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int OutWardDet_GridStyle(DataGridViewColumnCollection tmp)
        {
            tmp.Clear();
            ...
            tmp.Add(CommonView.GetGridViewColumn("WstWt", "WstWt", 0, 8, false, DataGridViewContentAlignment.MiddleLeft, "#####0.000"));
            tmp.Add(CommonView.GetGridViewColumn("Rate", "Rate", 0, 9, false, DataGridViewContentAlignment.MiddleLeft, "#####0.000"));
            tmp.Add(CommonView.GetGridViewColumn("Amount", "Amount", 0, 10, true, DataGridViewContentAlignment.MiddleLeft, "#####0.000"));
        ...
        public DataTable Print(int OutwardId)
        {
            SqlConnection MyCon = new SqlConnection();
            SqlCommand MyCmd = new SqlCommand();
            SqlParameter MyParam = new SqlParameter();
            ...
            MyCmd = new SqlCommand("Qry_OutwardHDr", MyCon);
            MyCmd.CommandType = CommandType.StoredProcedure;

            MyParam = new SqlParameter("@OutwardId", SqlDbType.Int);
            MyParam.Value = OutwardId;
            MyCmd.Parameters.Add(MyParam);
