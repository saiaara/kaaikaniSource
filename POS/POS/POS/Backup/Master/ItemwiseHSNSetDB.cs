...
namespace RLPOSDB
{
	...
	/// </summary>
	public class ItemwiseHSNSetDB
	{
        public ItemwiseHSNSetDB()
		{
			//
        ...
        public DataTable CatHsnSource()
        {
            ...
            Con.Open();
            SqlCommand Cmd;
            Cmd = new SqlCommand("Qry_CatHSNCode", Con);
        ...
        public int CatHsn_GridStyle(DataGridViewColumnCollection tmp)
        {
            tmp.Clear();
            ...
            tmp.Add(CommonView.GetGridViewColumn("HSNCode", "HSNCode", 100,3, false, DataGridViewContentAlignment.MiddleLeft, ""));
        ...
        public DataTable ItemHsnSource(int CatId)
        {
            ...
            MyCmd = new SqlCommand("Qry_ItemHSNCode", MyCon);
            MyCmd.CommandType = CommandType.StoredProcedure;

            MyParam = new SqlParameter("@CatId", SqlDbType.Int);
            MyParam.Value = CatId;
        ...
        public int ItemHsn_GridStyle(DataGridViewColumnCollection tmp)
        {
            tmp.Clear();
            ...
            tmp.Add(CommonView.GetGridViewColumn("HSNCode", "HSNCode", 100, 4, false, DataGridViewContentAlignment.MiddleLeft, ""));
            tmp.Add(CommonView.GetGridViewBoolColumn("HsnChange", "HsnChange", 80, 5));
           ...
           try
            {
                ...
                Con.Open();
                SqlCommand Cmd;
                Cmd = new SqlCommand("HSNSettingSP", Con);
                Cmd.CommandType = CommandType.StoredProcedure;
                ...
                param = new SqlParameter("@HsnChange", SqlDbType.Bit);
                param.Value = _HSNChange;
                Cmd.Parameters.Add(param);
