...
namespace RLPOSDB
{
	...
	/// </summary>
    public class RptPurAnnexureGstDB
	{
        public RptPurAnnexureGstDB()
		{
			//
        ...
        public DataTable SaleAnnexRptSourceSummary(DateTime FrmDt, DateTime ToDt)
        {
            ...
            Con.Open();
            SqlCommand Cmd;
            Cmd = new SqlCommand("Qry_RptpurAnnexGSTSummary", Con);
            Cmd.CommandType = CommandType.StoredProcedure;
            ...
            Da.SelectCommand = Cmd;
            Da.Fill(Tbl);
            Tbl.TableName = "Qry_RptpurAnnexGSTSummary";
            Da.Dispose();
            Cmd.Dispose();
            Con.Close();
            return Tbl;
        ...
        public DataTable SaleAnnexRptSourceGst2(DateTime FrmDt, DateTime ToDt,string Yr)
        {
            ...
            Con.Open();
            SqlCommand Cmd;
            Cmd = new SqlCommand("Qry_RptpurAnnexure_Gst2", Con);
            Cmd.CommandType = CommandType.StoredProcedure;
            SqlParameter param = new SqlParameter("@FrmDt", SqlDbType.DateTime);
            param.Value = FrmDt;
            Cmd.Parameters.Add(param);
            ...
            Da.SelectCommand = Cmd;
            Da.Fill(Tbl);
            Tbl.TableName = "Qry_RptpurAnnexure_Gst2";
            Da.Dispose();
            Cmd.Dispose();
            Con.Close();
            return Tbl;
        ...
        public DataTable SaleAnnexRptSourceGst2Summary(DateTime FrmDt, DateTime ToDt, string Yr)
        {
            ...
            Con.Open();
            SqlCommand Cmd;
            Cmd = new SqlCommand("Qry_RptpurAnnexure_Gst2Summary", Con);
            Cmd.CommandType = CommandType.StoredProcedure;
            ...
            Da.SelectCommand = Cmd;
            Da.Fill(Tbl);
            Tbl.TableName = "Qry_RptpurAnnexure_Gst2Summary";
            Da.Dispose();
            Cmd.Dispose();
            Con.Close();
            return Tbl;
