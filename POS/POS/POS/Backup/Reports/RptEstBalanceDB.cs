...
namespace RLPOSDB
{
    ...
    /// </summary>
    public class RptEstBalanceDB
    {
        public RptEstBalanceDB()
        {
            //
        ...
        public DataTable CustomerBalance_Source(string Cond)
        {
            ...
            MyCmd = new SqlCommand("Qry_EstCustomerBalance", MyCon);
            ...
            DTbl.TableName = "Qry_EstCustomerBalance";
            MyAdapt.Dispose();
            MyCmd.Dispose();
            MyCon.Close();
            return DTbl;
        ...
        public int CustomerBalance_GridStyle(DataGridViewColumnCollection tmp)
        {
            ...
            tmp.Add(CommonView.GetGridViewColumn("Balance", "Balance", 80, 10, true, DataGridViewContentAlignment.MiddleRight));
            tmp.Add(CommonView.GetGridViewColumn("Bal", "Bal", 0, 11));
        ...
        public DataTable SupplierBalance_Source(string Cond)
        {
            ...
            MyCmd = new SqlCommand("Qry_EstSupplierBalance", MyCon);
            MyCmd.CommandType = CommandType.StoredProcedure;
            ...
            DTbl.TableName = "Qry_EstSupplierBalance";
            MyAdapt.Dispose();
            MyCmd.Dispose();
            MyCon.Close();
            return DTbl;
