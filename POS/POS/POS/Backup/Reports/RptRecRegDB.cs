...
namespace RLPOSDB
{
    ...
    public class RptRecRegDB
    {
        ...
        public int RptRec_GridStyle(DataGridViewColumnCollection tmp)
        {
            ...
            tmp.Add(CommonView.GetGridViewColumn("Area", "Area", 100, 7, true, DataGridViewContentAlignment.MiddleLeft, ""));
        ...
        public int RptPay_GridStyle(DataGridViewColumnCollection tmp)
        {
            ...
            tmp.Add(CommonView.GetGridViewColumn("Area", "Area", 100, 6, true, DataGridViewContentAlignment.MiddleLeft, ""));
