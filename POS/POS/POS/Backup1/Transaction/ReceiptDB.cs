...
namespace AccountsDB
{
    ...
    public class ReceiptDB
    {
        ...
        public DataTable BillNo_Source(int RecId,int AccID,bool Mode)
        {
            SqlConnection MyCon = new SqlConnection();
            SqlCommand MyCmd = new SqlCommand();
            SqlParameter MyParam = new SqlParameter();
            ...
            MyCmd = new SqlCommand("Qry_RecPending", MyCon);
            MyCmd.CommandType = CommandType.StoredProcedure;
...
# endregion
        ...
        public DataTable navigate(bool All)
        {
            ...
            Con.Open();
            SqlCommand Cmd;
            Cmd = new SqlCommand("Select Top 100 * From ReceiptHdrNewvwFn('" + All + "'," + Common.CId + ") where RecId > 0 order by RecId desc", Con);
        ...
        public void SetViewControl(bool All)
        {
            ...
            _View.TableNames = "ReceiptHdrNewvwFn('" + All + "'," + Common.CId + ")";
            _View.Fields = "*";
